...
var BasicView = /** @class */ (function (_super) {
    ...
    BasicView.prototype.renderSkeleton = function () {
        ...
        dayGridContainerEl = this.scroller.el.addClass('fc-day-grid-container mh-120 overflow-hs');
        ...
        if (buttonStr) {
            $.each(buttonStr.split(' '), function (i, buttonGroupStr) {
                ...
                $.each(buttonGroupStr.split(','), function (j, buttonName) {
                    ...
                    var buttonAriaAttr;
                    if (buttonName === 'title') {
                        groupChildren = groupChildren.add($('<h2 style="font-size: 12px; margin: 5px 0px 0px 0px;">&nbsp;</h2>')); // we always want it to take up height
                        isOnlyButtons = false;
                    }
                    else {
